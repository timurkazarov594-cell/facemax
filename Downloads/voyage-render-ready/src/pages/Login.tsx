      ...
      <main className="flex-grow flex items-center justify-center px-5 pb-20">
        ...
        >
          <div className="text-center mb-10">
            <h1 className="font-serif text-3xl text-white mb-2">Войти</h1>
          ...
          <p className="text-center text-sm text-muted-foreground/40 mt-8">
            Нет аккаунта?{' '}
            <Link href="/register" className="text-primary/70 hover:text-primary transition-colors underline underline-offset-4">
              Регистрация
            </Link>
          </p>
        </motion.div>

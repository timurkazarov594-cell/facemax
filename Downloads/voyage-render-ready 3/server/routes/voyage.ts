...
import { z } from "zod";
import { lookupHotelImage } from "../lib/hotel-images.js";
...
const PlanVoyageBody = z.object({
  destination: z.string(),
  travelLevel: z.string(),
  tripTypes: z.array(z.string()),
  hotelPrefs: z.array(z.string()),
  restaurantPrefs: z.array(z.string()),
  duration: z.string(),
  budget: z.string(),
  language: z.string(),
